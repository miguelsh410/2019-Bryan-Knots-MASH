...
public class Permute {
	...
	public static void main(String[] args) {
		int[] array = {0,1,2,3};
		permutations = new int[AllDiagonalKnotGrids.factorial(array.length)][array.length];
		permute(array);
	...
	//Code taken and adapted from https://stackoverflow.com/questions/30387185/print-out-all-permutations-of-an-array
